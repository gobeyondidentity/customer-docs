...
![Screenshot showing the distribution of scored entities (users, passkeys or authentications) across the fleet.](../../../static/img/authentication-risk-activity.png)
...
![Screenshot showing the list of users, passkeys, or authentications summarized in the bar chart above](../../../static/img/list-of-users-passkeys-or-authentications.png)
...
![Screenshot showing the Risk Overview filtering on Risk score group.](../../../static/img/filtering-users-last-30-days.png)

This view shows the interactive filtering options available. 

![Screenshot showing the Risk Overview filtering on Risk score group.](../../../static/img/risk-overview-filter.png)
