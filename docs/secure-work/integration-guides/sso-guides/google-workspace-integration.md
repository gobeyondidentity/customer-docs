...
*   data-renderer-start-pos="1755">SSO URL
*   SSO Entity ID
...
3.  On the “Groups” page, click **Create group**.  
    ![] (/images/google-workspace/create-group-workspace.png)
...
10.  For both the BI\_Admins and BI\_Users groups, click on the group name and then the group information tab. Set the label as “Security”. (There may be additional labels here.)
...
8.  On the Beyond Identity User Console App’s page under “user access”, click on the down arrow to configure “service status”.
    1.  Under Organization Units, select **Off for everyone**.
...
To set up test user, perform the following:
