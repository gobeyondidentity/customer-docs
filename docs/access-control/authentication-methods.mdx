...
To simplify the installation process, consider sending your employees an email that provides direct access to the download page and detailed instructions for setting up a passkey for authentication. Visit [Add Users](/docs/directory/manage-users/add) for more guidance on this.
