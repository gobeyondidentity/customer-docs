...
:::note
With the SCIM implementation, this means the Okta directory is the source of truth. Any changes made to your Okta directory will be pushed and reflected in the Beyond Identity directory.
:::
...
Now, when your users login to Okta, they will be prompted with Beyond Identity for seamless authentication experience.
:::