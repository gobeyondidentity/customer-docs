...
9. Copy the **Discovery Endpoint** value.
...
7. Paste the **Discovery Endpoint value** from the **Client Information & Endpoints** of [Step 9 of the previous section](#-set-up-beyond-identity-console) into the **Redirect URI** text field.
8. Click **Register**.
...
:::note
Before continuing with the integration, confirm that the user `objectid` value for your Entra users is the same as the `externalid` value in Beyond Identity. Review your SCIM mapping as needed.
:::
