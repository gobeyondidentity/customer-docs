---
title: Configuring Genetic OIDC
id: generic-oidc
...
3. Next, click the **Browse Identity Providers** tab, then select the **Genetic OIDC** tile.
...
- **OAuth2 PAR**: Enables Pushed Authorization Requests, where the authorization request payload is sent directly from Secure Access to the IdP. This allows improved security and larger request sizes.
