...
![Screenshot of rule definition for credential enrollment in Beyond Identity Console](../images/rule-definition.png)
...
1. [Download the Beyond Identity Platform Authenticator](https://app.byndid.com/downloads) according to your operating system.
    1. For Desktop users, navigate to [https://app.byndid.com/downloads](https://app.byndid.com/downloads) and install the app.
...
![Screenshot of Beyond Identity Platform Authenticator to set up other devices](../images/set-up-other.png)
1. On the operating system pop up, click **Yes, extend my passkey** to confirm.
![Screenshot of pop up from Beyond Identity Platform Authenticator to confirm credential enrollment and extend passkey](../images/cred-confirmation.png)
...
![Screenshot of 9 digit code input from Platform Authenticator](../images/9-digit-code.png)
...
For users coming from Secure Work, the Secure Access credential enrollment process is different. End users generate a QR code or a nine digit code from the new device and then input that information to the trusted device. 
