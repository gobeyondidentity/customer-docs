...
- Pending - Occurs when:
    ...
    - The enrollment code\credential hasn’t been added to the authenticator. For more information, see [Enroll a device]("docs/devices/enrolling-devices.mdx")
