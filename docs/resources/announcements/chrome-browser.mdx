...
#### Chrome Browser Example 1: **Local Network Access Prompt**

- When the prompt appears, click **Allow**.

    ![Chrome](../images/prompt1.png)
---

#### Chrome Browser Example 2: **Local Network Access Prompt**

1. When the prompt appears, click **Site settings**.  
2. In the **Local network access** drop-down menu, select **Allow**.  

    Your changes are saved automatically.  

    ![Chrome](../images/prompt2SA.png)
