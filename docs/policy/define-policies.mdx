...
...some messaging here about the basic steps to create a rule; also add in here links to the specific use cases...




You can set the rule attributes to the following:

<ul>
  <li>Type of transaction</li>
  <li>User attempting to authenticate</li>
  <li>Platform on the device</li>
  <li>Type of integration</li>
  <li>Beyond Identity Authentication version installed</li>
</ul>
