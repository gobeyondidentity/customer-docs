...
| -------- | ----------- |
| Android | **Android Login Service Crash on Timeout**<br /><br />On Android 15 and 16, an issue was resolved where the Login Service could crash after a timeout, typically following about six hours of inactivity. This behavior is newly required and enforced by Google, and the update ensures compatibility with the latest Android platform requirements. It is recommended that users upgrade to v2.107.1. |
