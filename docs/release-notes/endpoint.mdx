...
**Device360 supports Windows and macOS currently.** Click <ins>[here](/docs/deployment/authenticator-set-up#install-for-device360)</ins> to view supported platforms and install the authenticator.
