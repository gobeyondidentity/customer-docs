...
<details>
  <summary><p>Version 2.104.0 BI Authenticator Release Notes</p></summary>


<p>Beyond Identity began deploying its Platform Authenticator v2.104.0 on June 24, 2025. This release includes one new feature and a bug fix.</p>
