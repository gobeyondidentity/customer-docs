...
| Windows | **Updated Desktop Windows Login Process** — Improved the fingerprint enrollment flow to better align with Windows Hello. The flow now adapts based on whether Windows Hello is enabled, a PIN is created, or a fingerprint reader is available. Also improved access to fingerprint enrollment in passkey settings. [Read more](https://support.beyondidentity.com/hc/en-us/articles/33364910265239-Windows-Desktop-Login-Enrollment-Update). |
