...
When a Domain user unenrolls in the Beyond Identity Windows Login Desktop application, an event gets generated in the Admin Console.

![Beyond identity User performing an unenroll action](../images/un-enroll-from-desktop-login.png)

![An event in the Administrator Console Event Log, showing the unenroll action](../images/un-enroll-from-desktop-login-2.png)
...
For Windows Desktop enrollment failures, see the<a href="https://support.beyondidentity.com/hc/en-us/articles/14510599143703">Windows Desktop Login Enrollment Failure</a> support article.
