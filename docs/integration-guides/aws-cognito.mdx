...
title: AWS Cognito
id: aws-cognito
description: 'Set up Beyond Identity as a Passwordless login provider for applications that use AWS Cognito to manage their identities. '
slug: /aws-cognito 
keywords: 
 - faq
 - help
...
import awsCognitoFlow from '../images/aws/aws-diagram.svg';
...
import awsDiagramFlow from '../images/aws/aws-diagram.svg';
