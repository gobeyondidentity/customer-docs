...
import InformationProvidedToBeyondIdentity from '../../static/includes/_integration-guide-info-provided-to-beyond-identity.mdx';

<InformationProvidedToBeyondIdentity />

#### Information you'll <u>receive</u> from the Beyond Identity field team


import InformationReceivedFromBeyondIdentity from '../../static/includes/_integration-guide-info-received-from-beyond-identity.mdx';

<InformationReceivedFromBeyondIdentity />
