...
id: authenticator-set-up
description: "Learn about authenticators in Beyond Identity."
slug: /deployment/authenticator-set-up
keywords:
  - authenticators
...
To simplify the installation process, consider sending your employees an email that provides direct access to the download page and detailed instructions for setting up a passkey for authentication. Visit [Manage Passkeys](/docs/directory/identities#manage-passkeys) for more guidance on this.
...
If the enrollment code or passkey is deleted, you will need to [rebind the device](/docs/inventory/devices#rebind-devices).
