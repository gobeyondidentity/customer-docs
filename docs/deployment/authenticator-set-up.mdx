...
To simplify the installation process, consider sending your employees an email that provides direct access to the download page and detailed instructions for setting up a passkey for authentication. Visit [Manage Passkeys](identities#manage-passkeys) for more guidance on this.
...
If the enrollment code or passkey is deleted, you will need to [rebind the device](/docs/devices#rebind-devices).
