...
Device360 is available starting in version 2.92 or later. It is highly recommended that you update to the latest version of the Beyond Identity authenticator to ensure that you can access new features.  
