...
In this article, you'll find examples for creating rules that apply to a specific transaction type or all types.
...
4. The **Add Rule** dialog is displayed. 
  ...
  The Add Rule dialog provides attributes for setting policy related to the:
  
  - Type of transaction

  - User attempting to authenticate

  - Patform on the device

  - Type of integration

  - Beyond Identity Authentication version installed

  *do we put an expandable here with the policy list?*
