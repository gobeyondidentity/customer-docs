...
3. [Simulate policy rules](/docs/policy-simulation) to see how different rules would affect your users' ability to access secure systems to help you get confident with heightened security posture BEFORE you apply it.
