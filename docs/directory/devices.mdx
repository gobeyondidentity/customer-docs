...
- Pending - Device is not yet enrolled.
  :::note
  The enrollment code expires after 10 minutes so you may need to generate a new code for the device. For more information, see <ins>[Generate a new enrollment code](/docs/access-control/authentication-methods#generate-a-new-enrollment-code)</ins>
  :::
