...
When you add a passkey for 

1. Select **Directory > Identities** and click an identity from the list. You can use the Search bar to search for a user if needed.

   ![Passkey tab](../images/directory/passkeys-tab.png)
...
- Select **Directory > Identities** and click an identity from the list. You can use the Search bar to search for a user if needed.
