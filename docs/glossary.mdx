...
When your tenant gets deployed, the Beyond Identity Admin Realm gets created and populated for you. It's a unique administrative domain created for you in your tenant when you signed up for your account. 
