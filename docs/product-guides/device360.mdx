...
1. [Install the authenticator](/docs/authenticators#install-for-device360) on devices in your organization and enroll the devices to begin collecting data.

   -or-

   Secure Workforce customers that have the latest authenticator installed can simply add a code to their authenticator to enroll their device. For more information, see [Secure Workforce customer enrollment](/docs/authenticators#secure-workforce-customer-enrollment).
