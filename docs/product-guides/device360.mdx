...
1. [Install the authenticator](/docs/authenticator-set-up#install-for-device360) on devices in your organization and enroll the devices to begin collecting data.

   -or-

   Secure Workforce customers that have the latest authenticator installed can simply add a code to their authenticator to enroll their device. For more information, see [Secure Workforce customer enrollment](/docs/authenticator-set-up#secure-workforce-customer-enrollment).

2. [Analyze devices](/docs/devices) to view details about enrollment status, misconfigurations, etc.

2. [Run queries](/docs/device-query) on devices to find misconfigurations that can lead to vulnerabilities.

3. [Simulate policy rules](/docs/policy-and-simulation) to see how different rules would affect your users' ability to access secure systems to help you get confident with heightened security posture BEFORE you apply it.
