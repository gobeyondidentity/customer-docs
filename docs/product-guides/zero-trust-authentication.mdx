...
2. [Configure integrations.](/docs/platform/integrations)

3. [Add policy rules](/docs/policy/rules) to allow or deny authentications. 

4. (Optional) [Configure branding](/docs/customization/branding) to match your corporate look-and-feel for the email that will be sent to users to enroll their devices.
