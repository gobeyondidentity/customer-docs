...
2. [Configure integrations, if available.](/docs/tools/integration-catalog)

3. [Add policies.](/docs/tools/policy) 

4. (Optional) [Configure branding](/docs/deployment/branding) to match your corporate look-and-feel for the email that will be sent to users to enroll their devices. 
