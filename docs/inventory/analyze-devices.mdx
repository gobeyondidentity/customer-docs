...
- Pending - Occurs when:
    ...
    - The enrollment code\credential hasn’t been added to the authenticator. For more information, see [Rebind a device](https://docs.beyondidentity.com/docs/rebind-device).
