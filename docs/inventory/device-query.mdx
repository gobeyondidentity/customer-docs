...
7. When complete, click the **Query Name** to view results. You don't have to wait for the query to complete to view the results. For more information, see [View query results](https://docs.beyondidentity.com/docs/view-query-results).
...
2. To run a query, see "Run a device query."
