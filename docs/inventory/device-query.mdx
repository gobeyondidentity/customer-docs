...
7. When complete, click the **Query Name** to view results. You don't have to wait for the query to complete to view the results. For more information, see View query results below.
