...
🟠 Google PubSub: Google PubSub platform tasks are highlighted in orange.

## Stage I

The sections in this stage are for the intial setup of the integration between the two platforms.

### 🟠 Create Google PubSub project
...
4. On the Cloud Pub/Sub overview page, click **Add instance**.

## Stage II

The sections in this stage are for setting up the Google PubSub configuration in Beyond Identity and viewing the logs. Follow the sections below to complete the integration.

### 🔵 Configure Cloud PubSub integration in Beyond Identity
...
1. On the **Add integration** pop up after completing the steps in Add integration in Beyond Identity section, input the following required values.
    ...
    - Topic Name → Your PubSub topic name
