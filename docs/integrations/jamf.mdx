...
**A.** The [Fetch Data from Integration](https://docs.beyondidentity.com/docs/release-notes/release-notes-changelog#april-14-2025) event log records failed data retrieval attempts from Jamf Pro.
