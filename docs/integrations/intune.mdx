...
After configuring Intune, add the integration using the 🔵 Beyond Identity console.
...
|-----------|------|--------|-------------|
| Connection Available | boolean | policy | Checks whether the connection to Intune is available. |
...
**Q.** How can I check if my device is connected to Intune and troubleshoot connection issues?  

**A.** The [Fetch Data from Integration](https://support.beyondidentity.com/hc/en-us/articles/31623732788631-April-20th-2025-Cloud-Release-Notes) event log records failed data retrieval attempts from Intune.
