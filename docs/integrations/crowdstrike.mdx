...
**A.** The [Fetch Data from Integration](https://support.beyondidentity.com/hc/en-us/articles/31623732788631-April-20th-2025-Cloud-Release-Notes) event log records failed data retrieval attempts from CrowdStrike.
