...
//    Svg: require('@site/static/img/Details-page-02.svg').default,
    ...
    description: (
      <>
         Set up Beyond Identity as a Passwordless login provider for applications that use AWS Cognito to manage identities.
      </>
    ),
    href: ('/aws-cognito'),
    label: ('Learn more'),
...
function CiamSso({ title, description, href }) {
  return (
